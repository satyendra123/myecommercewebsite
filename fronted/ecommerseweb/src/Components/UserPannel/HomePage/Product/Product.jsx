...
const Product = () => {
    ...
    return (
        <div>
            <h1>Product</h1>
            <p className="product-paragraph">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eos ab, minus provident vero dolore natus reiciendis sequi unde rerum delectus architecto porro aperiam dolorum omnis? Vero repudiandae cumque ex hic.</p>
